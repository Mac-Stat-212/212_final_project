...
Names: Write down names of all team members
Wesley Stone, Alan Schulz
...
Is there significant anchoring bias in the stock market? If so, does it appear in certain types of stocks?
Does bias appear based on different buyers (eg. individuals being more susceptible than big organizations?)?
...
```{r}
stonks1 <- read_csv("HistoricalData_1727474190073.csv")
stonks2 <- read_csv("HistoricalData_1727474206036.csv")
stonks3 <- read_csv("HistoricalData_1727474221394.csv")
stonks4 <- read_csv("HistoricalData_1727474246245.csv")
stonks5 <- read_csv("HistoricalData_1727474945219.csv")
stonks6 <- read_csv("HistoricalData_1727474957879.csv")
stonks7 <- read_csv("HistoricalData_1727474288120.csv")
stonks8 <- read_csv("HistoricalData_1727474300447.csv")
stonks9 <- read_csv("HistoricalData_1727474311890.csv")
stonks10 <- read_csv("HistoricalData_1727474323497.csv")
```
...
Price:
Close/last: the stock price at the close of trading that day
